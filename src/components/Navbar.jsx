...
function Navbar() {
  ...
  return (
    <div className='flex justify-between items-center w-full h-15 text-black'>
      ...
      <ul className='md:flex hidden mr-[1rem]'>
      {links.map(({id,link}) =>(
      ...
      {nav && (
        <ul className='flex flex-col items-center absolute bg-gradient-to-b from-black to-gray-800 text-white top-[-30px] left-[-33px] w-[113vw] h-[60vh] justify-center  '>
        {links.map(({id,link}) =>(
