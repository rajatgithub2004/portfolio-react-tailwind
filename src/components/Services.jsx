...
function Services() {
  return (
    <div name="services" className='w-full text-black md:h-[24rem]'>
      <div className='max-w-screen-lg  mx-auto flex flex-col justify-center w-full '>
        ...
        <div>
          <div className='shadow-md h-2/4 shadow-gray-600 rounded-lg'>
            <img className='h-full w-full rounded-md duration-200 hover:scale-105 cursor-pointer' src={videoedit}  alt='graphicdesign' />
          </div>
          <div className='flex items-center flex-col justify-center'>
            <h1 className='font-bold mb-3 mt-5'>Video Editing</h1>
        ...
        <div>
          <div className='shadow-md h-2/4 shadow-gray-600 rounded-lg'>
            <img className='h-full w-full rounded-md duration-200 hover:scale-105 cursor-pointer' src={graphicdesign}  alt='graphicdesign' />
          </div>
            <div className='flex items-center flex-col justify-center'>
              <h1 className='font-bold mb-3 mt-5'>Graphic Designing</h1>
          ...
          <div>
          <div className='shadow-md h-2/4 shadow-gray-600 rounded-lg'>
            <img className='h-full w-full rounded-md duration-200 hover:scale-105 cursor-pointer' src={webdev}  alt='graphicdesign' />
          </div>
            <div className='flex items-center flex-col justify-center'>
              <h1 className='mb-3 font-bold mt-5'>Website Building</h1>
